            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TimeStamp = table.Column<byte[]>(rowVersion: true, nullable: true),
                    Details_Description = table.Column<string>(maxLength: 3800, nullable: true),
                    Details_ModelNumber = table.Column<string>(maxLength: 50, nullable: true),
                    Details_ModelName = table.Column<string>(maxLength: 50, nullable: true),
                    Details_ProductImage = table.Column<string>(maxLength: 150, nullable: true),
                    Details_ProductImageLarge = table.Column<string>(maxLength: 150, nullable: true),
                    Details_ProductImageThumb = table.Column<string>(maxLength: 150, nullable: true),
